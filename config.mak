...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-yasm --prefix=/usr/local/ffmpeg
...
CC_IDENT=gcc 5.1.1 (GCC) 20150618 (Red Hat 5.1.1-4)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
EXTRALIBS=-lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lasound -lSDL -lpthread -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
